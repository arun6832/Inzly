            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-xl">
                    <motion.div
                        ...
                        className="w-full max-w-xl bg-[#0a0a0c] border border-white/10 rounded-2xl p-8 sm:p-12 shadow-2xl relative overflow-hidden"
                    >
                        {/* Background Accents */}
                        ...
                        <div className="relative z-10 space-y-8 text-center">
                            <div className="w-20 h-20 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center mx-auto shadow-inner">
                            ...
                            <div className="p-6 rounded-xl bg-white/[0.02] border border-white/[0.05] text-left space-y-4">
                            ...
                            <div className="pt-4">
                                <Button
                                    onClick={onAccept}
                                    className="w-full h-14 bg-indigo-500 hover:bg-indigo-600 text-white rounded-xl font-black uppercase tracking-[0.2em] text-[11px] shadow-xl shadow-indigo-500/20 transition-all active:scale-95"
                                >
                                    I Agree & Continue
                                </Button>
